...
For those interested in the theoretical foundations and implementation details of COLOSS, a comprehensive **published paper** is available at [https://www.sciencedirect.com/science/article/abs/pii/S0010465525000712?via%3Dihub](https://www.sciencedirect.com/science/article/abs/pii/S0010465525000712?via%3Dihub). Furthermore, to facilitate the preparation of input files, which are crucial for defining the parameters of the scattering problem, a user-friendly **UI interface input file generator** named `coloss-input-generator.html` is provided. This tool enables users to generate the necessary input files with ease, ensuring a smooth start to their computational tasks.
